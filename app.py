        ...
        if team1_id == team2_id:
            ...
            if result:
                ...
                with col1:
                    ...
                    st.write(f"Seed: {team1_stats['Seed'] if team1_stats['Seed'] != 17 else 'Not in Tournament'}")
                    ...
                    st.write(f"KemPom Rating: {(float(team1_stats['OffensiveRating']) - float(team1_stats['DefensiveRating'])):.1f}")

                with col2:
                    st.write(f"**{team2_stats['TeamName']}**")
                    st.write(f"Seed: {team2_stats['Seed'] if team2_stats['Seed'] != 17 else 'Not in Tournament'}")
                    ...
                    st.write(f"KemPom Rating: {(float(team2_stats['OffensiveRating']) - float(team2_stats['DefensiveRating'])):.1f}")
